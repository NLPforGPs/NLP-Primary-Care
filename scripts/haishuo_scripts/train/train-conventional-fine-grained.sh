...
#SBATCH --mem=10G
#SBATCH --gres=gpu:1
#SBATCH --output=./log/train/train-conventional-fine-grained-16cat.out
#SBATCH --error=./log/train/train-conventional-fine-grained-16cat.err
