...
#SBATCH --mem=20G
#SBATCH --gres=gpu:1
#SBATCH --output=./log/test/test-mlm-original.out
#SBATCH --error=./log/test/test-mlm-original.err
...
# time python3 ./run_plms.py --batch_size 32  --pretrained_model microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract --model_dir models/mlm --model_name mlm-abstract-5e-5 --prompt 'This is a problem of {}.' --predict_data_dir 'transcripts-er' --do_predict --use_mlm --load_checkpoint
